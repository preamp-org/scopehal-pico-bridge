...
#define PS3000_MAX_ETS_SAMPLES 100000

#define PS3000_MAX_PULSE_WIDTH_QUALIFIER_COUNT 16777215L
#define PS3000_MAX_HOLDOFF_COUNT 8388607L
...
PREF0 PREF1 PICO_STATUS PREF2 PREF3(ps3000_get_unit_info)
(
  int16_t  handle,
  int8_t  *string,
...
// Adv Trigger
//===========================================================
typedef enum enPS3000ThresholdDirection
{
  PS3000_ABOVE,
  PS3000_BELOW,
  PS3000_RISING,
  PS3000_FALLING,
  PS3000_RISING_OR_FALLING,
  PS3000_INSIDE = PS3000_ABOVE,
  PS3000_OUTSIDE = PS3000_BELOW,
  PS3000_ENTER = PS3000_RISING,
  PS3000_EXIT = PS3000_FALLING,
  PS3000_ENTER_OR_EXIT = PS3000_RISING_OR_FALLING,
  PS3000_NONE = PS3000_RISING
} PS3000_THRESHOLD_DIRECTION;

typedef enum enPS3000ThresholdMode
{
  PS3000_LEVEL,
  PS3000_WINDOW
} PS3000_THRESHOLD_MODE;

typedef enum enPS3000TriggerState
{
  PS3000_CONDITION_DONT_CARE,
  PS3000_CONDITION_TRUE,
  PS3000_CONDITION_FALSE,
  PS3000_CONDITION_MAX
} PS3000_TRIGGER_STATE;

typedef enum enPS3000PulseWidthType
{
  PS3000_PW_TYPE_NONE,
  PS3000_PW_TYPE_LESS_THAN,
  PS3000_PW_TYPE_GREATER_THAN,
  PS3000_PW_TYPE_IN_RANGE,
  PS3000_PW_TYPE_OUT_OF_RANGE
} PS3000_PULSE_WIDTH_TYPE;

#pragma pack(1)
typedef struct tPS3000TriggerChannelProperties
{
  int16_t thresholdMajor;
  int16_t thresholdMinor;
  uint16_t hysteresis;
  int16_t channel;
  PS3000_THRESHOLD_MODE thresholdMode;
} PS3000_TRIGGER_CHANNEL_PROPERTIES;
#pragma pack()

#pragma pack(1)
typedef struct tPS3000TriggerConditions
{
  PS3000_TRIGGER_STATE channelA;
  PS3000_TRIGGER_STATE channelB;
  PS3000_TRIGGER_STATE channelC;
  PS3000_TRIGGER_STATE channelD;
  PS3000_TRIGGER_STATE external;
  PS3000_TRIGGER_STATE pulseWidthQualifier;
} PS3000_TRIGGER_CONDITIONS;
#pragma pack()

#pragma pack(1)
typedef struct tPS3000PwqConditions
{
  PS3000_TRIGGER_STATE channelA;
  PS3000_TRIGGER_STATE channelB;
  PS3000_TRIGGER_STATE channelC;
