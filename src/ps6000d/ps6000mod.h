...
#define PS6000_MAX_PULSE_WIDTH_QUALIFIER_COUNT 16777215L

#define PS6000_MAX_SIG_GEN_BUFFER_SIZE  16384
#define PS640X_C_D_MAX_SIG_GEN_BUFFER_SIZE 65536

#define PS6000_MIN_SIG_GEN_BUFFER_SIZE        1
#define PS6000_MIN_DWELL_COUNT                3
#define PS6000_MAX_SWEEPS_SHOTS ((1 << 30) - 1)

#define PS6000_MAX_WAVEFORMS_PER_SECOND  1000000

// supported by the PS6402 and PS6403
// for other devices use GetAnalogueOffset also
// PS6402 and PS6403 supports this function
#define PS6000_MAX_ANALOGUE_OFFSET_50MV_200MV  0.500f
#define PS6000_MIN_ANALOGUE_OFFSET_50MV_200MV -0.500f
#define PS6000_MAX_ANALOGUE_OFFSET_500MV_2V    2.500f
#define PS6000_MIN_ANALOGUE_OFFSET_500MV_2V   -2.500f
#define PS6000_MAX_ANALOGUE_OFFSET_5V_20V        20.f
#define PS6000_MIN_ANALOGUE_OFFSET_5V_20V       -20.f
