...
#define PS4000_MAX_PULSE_WIDTH_QUALIFIER_COUNT 16777215L
#define PS4000_MAX_DELAY_COUNT 8388607L

#define PS4000_MIN_SIG_GEN_FREQ          0.0f
#define PS4000_MAX_SIG_GEN_FREQ     100000.0f
#define PS4000_MAX_SIG_GEN_FREQ_4262 20000.0f

// applicable to all variants with a signal generator
#define PS4000_MIN_SIG_GEN_BUFFER_SIZE    1
...
#define PS4000_MAX_SWEEPS_SHOTS     ((1 << 30) - 1)

typedef enum enPS4000ChannelBufferIndex
{
...
{
  PS4000_P_NONE,
  PS4000_P_CURRENT_CLAMP_10A,
  PS4000_P_CURRENT_CLAMP_1000A,
  PS4000_P_TEMPERATURE_SENSOR,
  PS4000_P_CURRENT_MEASURING_DEVICE,
  PS4000_P_PRESSURE_SENSOR_50BAR,
  PS4000_P_PRESSURE_SENSOR_5BAR,
  PS4000_P_OPTICAL_SWITCH,
  PS4000_P_UNKNOWN,
  PS4000_P_MAX_PROBES = PS4000_P_UNKNOWN
} PS4000_PROBE;

typedef enum enPS4000ChannelInfo
{
  PS4000_CI_RANGES,
  PS4000_CI_RESISTANCES,
  PS4000_CI_ACCELEROMETER,
  PS4000_CI_PROBES,
  PS4000_CI_TEMPERATURES
} PS4000_CHANNEL_INFO;
...
typedef enum enPS4000ThresholdDirection
{
  ...
  PS4000_RISING_LOWER,       // using lower threshold
  PS4000_FALLING_LOWER,     // using lower threshold
