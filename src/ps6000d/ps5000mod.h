...
#define PS5000_MAX_PULSE_WIDTH_QUALIFIER_COUNT 16777215L
#define PS5000_MAX_DELAY_COUNT 8388607L

#define PS5000_MAX_SIG_GEN_BUFFER_SIZE 8192
#define PS5000_MIN_SIG_GEN_BUFFER_SIZE 10
#define PS5000_MIN_DWELL_COUNT         10
#define PS5000_MAX_SWEEPS_SHOTS ((1 << 30) - 1)
...
typedef enum enPS5000ChannelBufferIndex
{
...
typedef enum enPS5000SweepType
{
  PS5000_UP,
  PS5000_DOWN,
  PS5000_UPDOWN,
  PS5000_DOWNUP,
  PS5000_MAX_SWEEP_TYPES
} PS5000_SWEEP_TYPE;

typedef enum enPS5000WaveType
{
  PS5000_SINE,
  PS5000_SQUARE,
  PS5000_TRIANGLE,
...
typedef enum enPS5000SigGenTrigType
{
  PS5000_SIGGEN_RISING,
  PS5000_SIGGEN_FALLING,
  PS5000_SIGGEN_GATE_HIGH,
  PS5000_SIGGEN_GATE_LOW
} PS5000_SIGGEN_TRIG_TYPE;

typedef enum enPS5000SigGenTrigSource
{
  PS5000_SIGGEN_NONE,
  PS5000_SIGGEN_SCOPE_TRIG,
  PS5000_SIGGEN_AUX_IN,
  PS5000_SIGGEN_EXT_IN,
  PS5000_SIGGEN_SOFT_TRIG
} PS5000_SIGGEN_TRIG_SOURCE;

typedef enum enPS5000IndexMode
{
  PS5000_SINGLE,
  PS5000_DUAL,
  PS5000_QUAD,
  PS5000_MAX_INDEX_MODES
} PS5000_INDEX_MODE;

typedef enum enPS5000ThresholdMode
{
  PS5000_LEVEL,
  PS5000_WINDOW
} PS5000_THRESHOLD_MODE;

typedef enum enPS5000ThresholdDirection
{
  PS5000_ABOVE,
  PS5000_BELOW,
  PS5000_RISING,
  PS5000_FALLING,
  PS5000_RISING_OR_FALLING,
  PS5000_INSIDE = PS5000_ABOVE,
  PS5000_OUTSIDE = PS5000_BELOW,
  PS5000_ENTER = PS5000_RISING,
  PS5000_EXIT = PS5000_FALLING,
  PS5000_ENTER_OR_EXIT = PS5000_RISING_OR_FALLING,
  PS5000_NONE = PS5000_RISING
} PS5000_THRESHOLD_DIRECTION;

typedef enum enPS5000TriggerState
{
  PS5000_CONDITION_DONT_CARE,
  PS5000_CONDITION_TRUE,
  PS5000_CONDITION_FALSE,
  PS5000_CONDITION_MAX
} PS5000_TRIGGER_STATE;

#pragma pack(push,1)
typedef struct tPS5000TriggerConditions
{
  PS5000_TRIGGER_STATE channelA;
  PS5000_TRIGGER_STATE channelB;
  PS5000_TRIGGER_STATE channelC;
  PS5000_TRIGGER_STATE channelD;
  PS5000_TRIGGER_STATE external;
  PS5000_TRIGGER_STATE aux;
  PS5000_TRIGGER_STATE pulseWidthQualifier;
} PS5000_TRIGGER_CONDITIONS;
#pragma pack(pop)

#pragma pack(push,1)
typedef struct tPS5000PwqConditions
{
  PS5000_TRIGGER_STATE channelA;
  PS5000_TRIGGER_STATE channelB;
  PS5000_TRIGGER_STATE channelC;
  ...
  PS5000_TRIGGER_STATE external;
  PS5000_TRIGGER_STATE aux;
} PS5000_PWQ_CONDITIONS;
#pragma pack(pop)

#pragma pack(push,1)
typedef struct tPS5000TriggerChannelProperties
{
  int16_t thresholdMajor;
  int16_t thresholdMinor;
  uint16_t hysteresis;
  PS5000_CHANNEL channel;
  PS5000_THRESHOLD_MODE thresholdMode;
} PS5000_TRIGGER_CHANNEL_PROPERTIES;
#pragma pack(pop)

typedef enum enPS5000RatioMode
{
  PS5000_RATIO_MODE_NONE = 0,
  PS5000_RATIO_MODE_AGGREGATE = 1,
  PS5000_RATIO_MODE_DECIMATE = 2,
  PS5000_RATIO_MODE_AVERAGE = 4,
  PS5000_RATIO_MODE_DISTRIBUTION = 8
} PS5000_RATIO_MODE;

typedef enum enPS5000PulseWidthType
{
  PS5000_PW_TYPE_NONE,
  PS5000_PW_TYPE_LESS_THAN,
  PS5000_PW_TYPE_GREATER_THAN,
  PS5000_PW_TYPE_IN_RANGE,
  PS5000_PW_TYPE_OUT_OF_RANGE
} PS5000_PULSE_WIDTH_TYPE;
...
(
  ...
  PS5000_SWEEP_TYPE   sweepType,
  int16_t             whiteNoise,
  PS5000_INDEX_MODE          indexMode,
  uint32_t            shots,
  uint32_t            sweeps,
  PS5000_SIGGEN_TRIG_TYPE    triggerType,
  PS5000_SIGGEN_TRIG_SOURCE  triggerSource,
...
(
  int16_t                     handle,
  PS5000_TRIGGER_CHANNEL_PROPERTIES *channelProperties,
...
(
  int16_t             handle,
  PS5000_TRIGGER_CONDITIONS *conditions,
  int16_t             nConditions
);
...
(
  int16_t              handle,
  PS5000_THRESHOLD_DIRECTION  channelA,
  PS5000_THRESHOLD_DIRECTION  channelB,
  PS5000_THRESHOLD_DIRECTION  channelC,
  PS5000_THRESHOLD_DIRECTION  channelD,
  PS5000_THRESHOLD_DIRECTION  ext,
  PS5000_THRESHOLD_DIRECTION  aux
);
...
(
  ...
  int16_t              threshold,
  PS5000_THRESHOLD_DIRECTION  direction,
  uint32_t             delay,
...
(
  int16_t              handle,
  PS5000_PWQ_CONDITIONS      *conditions,
  int16_t              nConditions,
  PS5000_THRESHOLD_DIRECTION  direction,
  uint32_t             lower,
  uint32_t             upper,
  PS5000_PULSE_WIDTH_TYPE     type
);
